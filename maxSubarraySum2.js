/*
maxSubarraySum
Given an array of integers and anumber, write a function called maxSubarraySum, which finds
the maximun sum of a subarray with the length of the number passed to the function.
